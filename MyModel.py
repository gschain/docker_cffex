...
class MyModel(object):
    ...
    def __init__(self, bucket, model_key):
        ...
        self.s3 = connect_s3.ConnectS3(bucket, model_key, self.MODEL_DIR)
    ...
    def predict(self, X, features_names=None):
        ...
        return [e.to_dict(fields=['text', 'spans']) for e in exs]
...
# aa = MyModel("kubeflow-anonymous-test1", "test/2020-05-18T16-51-19Z/model-data")
